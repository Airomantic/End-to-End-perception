...
def traverse_images(nusc, proj_lidar=False, visible_level=2, save_dir=None):
...
if __name__ == '__main__':
    ...
    data_root = r'v1.0-mini'
    nusc = NuScenes(version='v1.0-mini',
                    dataroot=data_root,
                    verbose=True)
    traverse_images(nusc, proj_lidar=False, visible_level=1, save_dir='test')

...
def visualise_output(labels):
    ...
    for t in range(sequence_length):
        ...
        semantic_plot = np.zeros_like(semantic_plot)
...
def plot_planning(hd_map, traj):
    ...
    LIFT_Y_BOUND = [-50.0, 50.0, 0.5]  # Sides
    LIFT_Z_BOUND = [-10.0, 10.0, 20.0]

    dx, bx, _ = gen_dx_bx(LIFT_X_BOUND, LIFT_Y_BOUND, LIFT_Z_BOUND)
